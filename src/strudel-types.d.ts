...
declare module "@strudel/core" {
  ...
  export class Pattern extends Controls {
     ...
     * musical) sound.
     */
    queryArc: (start: Cycle, end: Cycle) => Hap<any>[];
  ...
  export type Patternable<T = number> =
    Pattern | Pattern[] | string | string[] | T | T[] | (T | T[] | Pattern)[];
...
declare module "@strudel/webaudio" {
   ...
   */
  export const setSuperdoughAudioController: (
...
declare module "@strudel/mini" {
   ...
   */
  export const mini: (...strings: string[]) => Patternable;
}
